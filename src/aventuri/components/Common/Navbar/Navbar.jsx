...
export const Navbar = () => {
  ...
  return (
    <header className='w-full bg-green-700 max-w-[1400px] mx-auto'>
      <div
        className={`main z-50 relative w-full ${
          pathname === '/' ? 'bg-blue-900/80' : 'bg-blue-400'
        }`}
      >
        ...
        <nav
          className={`fixed md:fixed md:m-auto -left-full md:left-0  md:flex-row w-9/12 md:w-full h-screen md:h-[50px]  ${
            isActive && 'left-0 '
          } md:items-center md:gap-3  bg-blue-950/45 md:bg-black/65 transition-all ease-in-out duration-500`}
        >
