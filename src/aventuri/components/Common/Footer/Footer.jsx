  ...
  return (
    <footer className="relative w-full h-[100vh] bg-blue-900">
      <div className='container2'>
        <figure className='absolute -top-[30px]  w-full z-30'>
          <img src={nubeFooter} alt="" className='w-full h-[160px] md:h-[200px] lg:h-[120px] object-center'/>
        </figure>
        ...
        <div className="h-screen w-full flex flex-col container2">
          ...
          <div className='relative w-full h-[40%] lg:h-[20%] flex flex-wrap flex-row pt-0 text-white'>
            <figure className='absolute -top-[70px]  w-full h-full'>
              <img src={footerAzul} alt="" className='object-center bg-no-repeat w-full h-[25rem] lg:h-[260px] z-20' />
            </figure>
            <div className="z-20 w-full lg:w-[40%] flex flex-row flex-wrap justify-center items-center pt-11">
            ...
            <div className='z-20 w-full lg:w-[60%] flex my-9'>
            ...
            <div className="z-20 w-full font-light text-sm flex flex-col justify-center items-center mb-3">
